...
namespace ADSDataDirect.Web.OpenModel
{
    public class OpenModelProcessor : ProData.ProDataApiManager
    {
        readonly static string clientCode = System.Configuration.ConfigurationManager.AppSettings["ClientCode"];
        public static readonly string UploadPath = HttpContext.Current.Server.MapPath($"~/Uploads");

        public static void PopulateFakeData(WfpictContext db, Campaign campaign)
        {
            // Process Links file
