            ...
            var ordersStatus = new CustomerOrdersStatusVm
                {
                    ...
                    Status = status,
                    Invoice_No = "1153",
                    Invoice_Date = System.DateTime.Now.ToString(StringConstants.DateFormatDashes),
                    NXS_IO_Number = orderNumberRdp,
                    Campaign_Type = campaignTypes[ct],
                    Campaign_Name = campaign.Approved.CampaignName,
                    Order_Date = campaign.CreatedAt.ToString(StringConstants.DateFormatDashes),
                    Broadcast_Date = campaign.Approved.DeployDate?.ToString(StringConstants.DateFormatDashes),
